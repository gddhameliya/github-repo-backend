...
const ApiResponse = {
    ...
    BAD_REQUEST: ({ res, message = '-', payload = {} }: { res: Response; message?: string; payload?: unknown }) => {
    ...
    DUPLICATE_VALUE: ({ res, message, payload = {} }: { res: Response; message?: string; payload?: unknown }) => {
    ...
    FORBIDDEN: ({ res, message = '-', payload = {} }: { res: Response; message?: string; payload?: unknown }) => {
    ...
    CATCH_ERROR: ({ res, message = '-', payload = {} }: { res: Response; message?: string; payload?: unknown }) => {
    ...
    NOT_ACCEPTABLE: ({ res, message = '-', payload = {} }: { res: Response; message?: string; payload?: unknown }) => {
    ...
    NOT_FOUND: ({ res, message = '-', payload = {} }: { res: Response; message?: string; payload?: unknown }) => {
    ...
    OK: ({ res, message = '-', payload = {} }: { res: Response; message?: string; payload?: unknown }) => {
    ...
    UNAUTHORIZED: ({ res, message = '-', payload = {} }: { res: Response; message?: string; payload?: unknown }) => {
    ...
    VALIDATION_ERROR: ({ res, message = '-', payload = {} }: { res: Response; message?: string; payload?: unknown }) => {
